      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-[48.65px] font-bold text-[#0088ffcf]">
            The Challenge of Industrial Collaboration
          </h2>
          <p className="mt-2 text-sm sm:text-base md:text-[24px] font-medium text-[#212529]">
            The collaboration challenges in today’s
          </p>
        ...
        >
          ...
          >
            <div className="p-6">
              ...
              <p className="font-mulish text-[16px] leading-[25px] text-[#212529]">
                Traditional supply chain communication is often disorganized,
                leading to delays in troubleshooting and resolving equipment
                breakdowns.
              </p>
            </div>
          ...
          >
            <div className="p-6">
              ...
              <p className="font-mulish text-[16px] leading-[25px] text-[#212529]">
                ...
                through unsecured channels, increasing the risk of data
                breaches.
              </p>
            </div>
          ...
          >
            <div className="p-6">
              ...
              <p className="font-mulish text-[16px] leading-[25px] text-[#212529]">
                Industrial plants struggle to quickly locate the right
                manufacturer, increasing downtime and operational losses.
              </p>
            </div>
